...
export default function DropdownAuditorio({ onBackClick,onAtrilClick,onSillaAuditorioClick }) {
  ...
  >
    <div className="dropdown-header">Auditorio</div>
      <ul>
         <li onClick={onAtrilClick}>Atril</li>
         <li onClick={onSillaAuditorioClick}>Sillas</li> 
